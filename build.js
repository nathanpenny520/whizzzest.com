...
const SOCIAL_ICONS = {
  ...
  // 分享本站（二维码组入口，docs/分享二维码方案.md）：QR 造型图形（evenodd 挖孔定位角 + 右下数据点）
  'share-site':
    '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><path fill-rule="evenodd" clip-rule="evenodd" d="M3 3h7v7H3V3zm2 2v3h3V5H5zM14 3h7v7h-7V3zm2 2v3h3V5h-3zM3 14h7v7H3v-7zm2 2v3h3v-3H5zM14 14h3v3h-3v-3zm5 0h2v2h-2v-2zm-5 5h2v2h-2v-2zm3-1h2v2h-2v-2zm3 1h2v2h-2v-2z"/></svg>',
